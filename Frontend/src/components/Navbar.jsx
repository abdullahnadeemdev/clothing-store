            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative" ref={profileRef}>
                <button
                  ...
                  className="flex items-center gap-1 p-2 text-gray-600 hover:text-black rounded-full hover:bg-gray-100"
                  aria-label="Profile"
                >
                  <User size={20} />
                  <ChevronDown
              ...
              <Link
                to="/cart"
                className="relative p-2 text-gray-600 hover:text-black rounded-full hover:bg-gray-100"
                aria-label="Cart"
              >
                <ShoppingBag size={20} />
                {cartCount > 0 && (
        ...
        >
          ...
          <nav className="flex flex-col px-6 py-6 gap-1">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 flex flex-col gap-1">
              <Link to="/login" className="py-3 px-4 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50">
                Login / Sign Up
              </Link>
              <Link to="/orders" className="py-3 px-4 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50">
                My Orders
              </Link>
              <Link to="/cart" className="py-3 px-4 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50">
                Cart ({cartCount})
              </Link>
            </div>
          </nav>
